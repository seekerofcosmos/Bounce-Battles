...
imgBackground = cv2.imread(r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Projectpong\Resources\Background.png")
imgGameOver = cv2.imread(r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Projectpong\Resources\gameOver.png")
imgBall = cv2.imread(r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Projectpong\Resources\Ball.png", cv2.IMREAD_UNCHANGED)
imgBat1 = cv2.imread(r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Projectpong\Resources\bat1.png", cv2.IMREAD_UNCHANGED)
imgBat2 = cv2.imread(r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Projectpong\Resources\bat2.png", cv2.IMREAD_UNCHANGED)

videoPath = r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Projectpong\Resources\StartVideo.mp4"
...
while True:
    ...
    if key != -1 and chr(key).lower() == 'r':  # Reset game (case-insensitive)
        ...
        gameOver = False
        score = [0, 0]
        imgGameOver = cv2.imread(r"C:\Users\anant\Desktop\TIET_ACAD\ODDSEM2425\edge\Resources\gameOver.png")
